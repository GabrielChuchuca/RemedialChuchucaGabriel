...
a persistence unit "RemedialChuchucaGabrielPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "RemedialChuchucaGabriel\pom.xml":
...
artifact ("RemedialChuchucaGabriel.war") is already built. You can build
